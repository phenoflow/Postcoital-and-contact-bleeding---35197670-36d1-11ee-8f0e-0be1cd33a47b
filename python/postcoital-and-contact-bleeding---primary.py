...
codes = [{"code":"1581.00","system":"readv2"},{"code":"K587.00","system":"readv2"},{"code":"K597.00","system":"readv2"},{"code":"K59A.00","system":"readv2"},{"code":"K59B.00","system":"readv2"},{"code":"12426.0","system":"med"},{"code":"1941.0","system":"med"},{"code":"46997.0","system":"med"},{"code":"47026.0","system":"med"},{"code":"6301.0","system":"med"}];
REQUIRED_CODES = 1;
